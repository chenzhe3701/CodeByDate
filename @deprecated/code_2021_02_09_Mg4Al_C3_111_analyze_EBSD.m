...
clear; clc; close all;
addChenFunction;
working_dir = 'E:\zhec umich Drive\2020-12-23 Mg4Al_C3 insitu EBSD\tolerance_1_1_1';
...
set(gca,'fontsize',18);
label_map_with_ID(x,y,ID_0,gcf, [12, 13, 144,136],'r',24,10);  % illustrate selected control grains  
...
ID_list{1} = [];
tolerance_cell{1} = [ ];
ID_list{2} = [110,121,134,138];
tolerance_cell{2} = [5,5,5,3];
ID_list{3} = [92,77,98,127,139,142,156,61];
tolerance_cell{3} = [5,5,5,5,5,5,3,5];
ID_list{4} = [76,94,139,158,177,180];
tolerance_cell{4} = [5,5,3,5,5,3];
ID_list{5} = [76,131,161,151,166];
tolerance_cell{5} = [5,3,5,5,3];
ID_list{6} = [70,87,104,122,142,159,162];
tolerance_cell{6} = [5,5,5,2,5,5,3];
ID_list{7} = [33,56,111,128,144,148,163];
tolerance_cell{7} = [5,5,5,5,5,3,3];
ID_list{8} = [33,119,132,145];
tolerance_cell{8} = [5,5,5,5];
ID_list{9} = [38,124,139,152];
tolerance_cell{9} = [5,5,5,5];
ID_list{10} = [35,109,73,132,124,138,141];
tolerance_cell{10} = [5,5,5,5,5,5,5,5,5];
ID_list{11} = [75,128,144,163,166,179,111];
tolerance_cell{11} = [5,2,5,5,3,2,5];
ID_list{12} = [39,67,102,139,156,159];
