...
for iE = 1:13    
    ...
    euler_aligned_to_sample = 1;
    save(fullfile(save_dir, ['Mg4Al_C3_parent_grain_file_iE_',num2str(iE),'.mat']),'euler_aligned_to_sample','ID','phi1','phi','phi2','x','y',...
        'gID','gPhi1','gPhi','gPhi2','gCenterX','gCenterY','gNNeighbors','gDiameter','gArea','gEdge','gNeighbors');
end
% For iE=0, use grain_file as parent_grain_file
copyfile(fullfile(save_dir, ['Mg4Al_C3_grain_file_iE_0.mat']), fullfile(save_dir, ['Mg4Al_C3_parent_grain_file_iE_0.mat']));

% save a copy after step 1
save_dir_1 = [save_dir,'\step-1'];
mkdir(save_dir_1);
for iE = 0:13
    copyfile(fullfile(save_dir, ['Mg4Al_C3_grain_file_iE_',num2str(iE),'.mat']), ...
           fullfile(save_dir_1, ['Mg4Al_C3_grain_file_iE_',num2str(iE),'.mat']));
    copyfile(fullfile(save_dir, ['Mg4Al_C3_parent_grain_file_iE_',num2str(iE),'.mat']), ...
           fullfile(save_dir_1, ['Mg4Al_C3_parent_grain_file_iE_',num2str(iE),'.mat']));
end
...
for iE = 0:13
    copyfile(fullfile(save_dir, ['Mg4Al_C3_parent_grain_file_iE_',num2str(iE),'.mat']), ...
           fullfile(save_dir_2, ['Mg4Al_C3_parent_grain_file_iE_',num2str(iE),'.mat']));
end
...
for iE = 1:13
    ...
    load(fullfile(save_dir, ['Mg4Al_C3_parent_grain_file_iE_',num2str(iE),'.mat']), 'ID','gID','gEdge','gCenterX','gCenterY');
...
maxID = 0;
for iE = 0:13
    f = matfile(fullfile(save_dir,['Mg4Al_C3_parent_grain_file_iE_',num2str(iE)]));
...
for iE = 0:13
    ...
    load(fullfile(save_dir,['Mg4Al_C3_parent_grain_file_iE_',num2str(iE)]));
    ...
    save(fullfile(save_dir, ['Mg4Al_C3_parent_grain_file_iE_',num2str(iE),'.mat']), 'euler_aligned_to_sample', ...
...
for iE = 0:13
    copyfile(fullfile(save_dir, ['Mg4Al_C3_parent_grain_file_iE_',num2str(iE),'.mat']), ...
           fullfile(save_dir_4, ['Mg4Al_C3_parent_grain_file_iE_',num2str(iE),'.mat']));
end
...
for iE = 1:13
    ...
    % Update the modified grain data and save
    save_dir_5 = [save_dir,'\step-5'];
    mkdir(save_dir_5);
    copyfile(fullfile(save_dir, ['Mg4Al_C3_parent_grain_file_iE_',num2str(iE),'.mat']), ...
            fullfile(save_dir_5, ['Mg4Al_C3_parent_grain_file_iE_',num2str(iE),'.mat']));
    gPhi1 = gPhi1_c;
    gPhi = gPhi_c;
    gPhi2 = gPhi2_c;
    save(fullfile(save_dir_5, ['Mg4Al_C3_parent_grain_file_iE_',num2str(iE),'.mat']), 'gPhi1','gPhi','gPhi2', '-append');
...
% % update and save the modified grain file
% save_dir_5 = [save_dir,'\step-5'];
% mkdir(save_dir_5);
% for iE = 0:13
%     copyfile(fullfile(save_dir, ['Mg4Al_C3_parent_grain_file_iE_',num2str(iE),'.mat']), ...
...
twinPct = zeros(14,8);
for iE = 1:13
    load(fullfile(save_dir, ['Mg4Al_C3_parent_grain_file_iE_',num2str(iE),'.mat']), 'ID');

    variant_map = variant_grain_wise{iE};
    if iE==1
