...
pole_figure_by_mtex(file_name, 'clims',clims);
print(fullfile(output_dir,'Mg4Al_B1 big aoi PF.tiff'),'-dtiff');
...
print(fullfile(output_dir, 'Mg4Al_fine avg pole figure.tiff'), '-dtiff');

pole_figure_by_mtex_multi_file(file_name_Mg4Al_medium, 'setting_str','setting 1', 'clims',clims);
print(fullfile(output_dir, 'Mg4Al_medium avg pole figure.tiff'), '-dtiff');
...
print(fullfile(output_dir, 'UM134_Mg_fine avg pole figure.tiff'), '-dtiff');

pole_figure_by_mtex_multi_file(file_name_UM129_Mg, 'setting_str','setting 1', 'clims',clims);
print(fullfile(output_dir, 'UM129_Mg_coarse avg pole figure.tiff'), '-dtiff');
