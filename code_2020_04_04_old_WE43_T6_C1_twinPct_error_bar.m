% This is just a copy of the old code for PRISMS
%
% chenzhe 2018-08-06
...
for ii=2:5
    text(strainPauses(ii) - 0.0012, 0 +tAvg(ii)*100,[num2str(100*tAvg(ii),2),'\pm',num2str(100*tStd(ii),2),'%'],'fontsize',14);
end
set(gca,'xdir','reverse','linewidth',1.5);
set(gca,'xlim',[-0.05, 0],'ylim',[0 11],'fontsize',18,'fontweight','normal');
xlabel('Global Strain (\fontsize{24}\epsilon\fontsize{18}^G)');
ylabel('Twin Area Percent, %');


%%
print('C:\Users\ZheChen\Desktop\Twin Area vs Global Strain.tif','-r300','-dtiff');
