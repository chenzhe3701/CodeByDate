...
set(gca,'fontsize',18);
label_map_with_ID(x,y,ID_0,gcf, [20,25, 207,185],'r',24,10);  % illustrate selected control grains  
...
strain_ebsd = [0.0000, -0.0004, -0.0046, -0.0088, -0.0105, ...
    -0.0094, -0.0022, 0.0041];
