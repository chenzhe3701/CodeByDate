...
working_dir = 'E:\zhec umich Drive\2021-01-15 UM134_Mg_C2 insitu curve';
cd(working_dir);
...
width = 3.44;       % UM134_Mg_C2, tested on 2021-01-15
thickness = 2.72;
%% make variable
time = A.data(:,1);
...
ind_stop = 1;
% load 0 -> 1
data = [data; A.data(4:1204,:)];
ind_stop = [ind_stop, size(data,1)];
% load 1 -> 2
data = [data; A.data(10803:10908,:)];
ind_stop = [ind_stop, size(data,1)];
% load 2 -> 3
data = [data; A.data(20403:20565,:)];
ind_stop = [ind_stop, size(data,1)];
% load 3 -> 4
data = [data; A.data(30553:30876,:)];
ind_stop = [ind_stop, size(data,1)];
% load 4 -> 5
data = [data; A.data(40404:41788,:)];
ind_stop = [ind_stop, size(data,1)];
% load 5 -> 6
data = [data; A.data(51303:51522,:)];
ind_stop = [ind_stop, size(data,1)];
% load 6 -> 7
data = [data; A.data(61004:61180,:)];
ind_stop = [ind_stop, size(data,1)];
% load 7 -> 8
data = [data; A.data(72603:74447,:)];
ind_stop = [ind_stop, size(data,1)];
% load 8 -> 9
data = [data; A.data(84903:85049,:)];
ind_stop = [ind_stop, size(data,1)];
% load 9 -> 10
data = [data; A.data(94603:94782,:)];
ind_stop = [ind_stop, size(data,1)];
% load 10 -> 11
data = [data; A.data(104303:106147,:)];
ind_stop = [ind_stop, size(data,1)];
% load 11 -> 12
data = [data; A.data(115703:115889,:)];
ind_stop = [ind_stop, size(data,1)];
% load 12 -> 13
data = [data; A.data(125353:125513,:)];
ind_stop = [ind_stop, size(data,1)];
% load 13 -> 14
data = [data; A.data(135020:135118,:)];
ind_stop = [ind_stop, size(data,1)];
