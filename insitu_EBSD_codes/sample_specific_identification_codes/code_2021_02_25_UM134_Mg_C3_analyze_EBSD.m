...
set(gca,'fontsize',18);
label_map_with_ID(x,y,ID_0,gcf, [43,40,275,250],'r',24,10);  % illustrate selected control grains  
...
strain_ebsd = [0.0000, -0.0284, -0.0374, -0.0452, ...
    -0.0403, -0.0304, -0.0142, -0.0011, ...
    -0.0173, -0.0313, -0.0427, ...
    -0.0295, -0.0141, -0.0015];
