...
set(gca,'fontsize',18);
label_map_with_ID(x,y,ID_0,gcf, [61,55, 384,387],'r',24,10);  % illustrate selected control grains  
...
strain_ebsd = [0.0000, -0.0156, -0.0252, -0.0296, ...
    -0.0280, -0.0215, -0.0109, -0.0022, ...
    -0.0123, -0.0213, -0.0308, ...
    -0.0205, -0.0103, -0.0014];
