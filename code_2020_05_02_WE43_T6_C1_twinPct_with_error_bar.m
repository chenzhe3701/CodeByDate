...
%
% chenzhe, 2020-05-02
% based on 'script_PRISMS_2019_twinPct_with_error_bar.m', adjust a little bit


clear twinPct;

% load('D:\p\m\DIC_Analysis\20190222_1217_relabeled_result.mat','trueTwinMapCell');
load('D:\p\m\DIC_Analysis\temp_results\WE43_T6_C1_new_variant_map_20200401.mat','trueTwinMapCell');
load('D:\p\m\DIC_Analysis\setting_for_real_samples\WE43_T6_C1_setting.mat','strainPauses');
load('D:\WE43_T6_C1\Analysis_by_Matlab_after_realign\WE43_T6_C1_EbsdToSemForTraceAnalysis_GbAdjusted.mat','ID');
...
for ii=2:5
    text(strainPauses(ii)-0.001 ,-0.1+tAvg(ii)*100, [num2str(100*tAvg(ii),2),'\pm',num2str(100*tStd(ii),2),'%'],'fontsize',16);
end
set(gca,'xdir','reverse','linewidth',1.5);
set(gca,'xlim',[-0.054, 0],'ylim',[-0.5 10],'fontsize',18,'fontweight','normal');
