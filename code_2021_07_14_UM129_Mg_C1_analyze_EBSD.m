...
set(gca,'fontsize',18);
label_map_with_ID(x,y,ID_0,gcf, [32,20, 72,92],'r',24,10);  % illustrate selected control grains  
...
strain_ebsd = [0.0000, -0.0105, -0.0172, -0.0265, ...
-0.0249, -0.0183, -0.0082, -0.0019, ...
-0.0099, -0.0174, -0.0266, ...
-0.0202, -0.0101, -0.0027];
